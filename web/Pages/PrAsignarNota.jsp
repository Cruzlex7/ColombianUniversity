        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="PrInicio.jsp"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                            </li>

                            <li>
                                <a href="PrAsignarNota.jsp"><i class="fa fa-edit fa-fw"></i> Asignar Nota</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
            ...
            <div id="page-wrapper">
                ...
                <div>
                    <br>
                    <br>
                    <h3 class="panel-title">Estudiantes relacionados</h3>
                    <br>
                    <table class="table table-bordered">
                        ...
                        <%
                            ArrayList<Object[]> estudiantes = new ProfesorDAO().buscarAlumnosyCarrera();
                            for (Object[] es : estudiantes) {
                        %>
                        <tr>
                            <td class="danger text-center text-muted"><%=es[0]%></td>
                            <td class="danger text-center text-muted"><%=es[1]%></td>
                            <td class="danger text-center text-muted"><%=es[2]%></td>
                        </tr>
                        <% }%>
                    </table>
                </div>
