    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <!-- /.row -->
                <div class="row">
                    <form role="form" method="POST" action="../AgregarMateria">
                        <label for="exampleInputName2">Nombre de la materia</label>
                        <input type="text" class="form-control" name="txtNombreMateria" placeholder="Materia">
                        <br>
                ...
                <div class="row">
                    <form role="form" method="POST" action="../EliminarMateria">
                        <br>
                        <label for="exampleInputName2">Codigo de la materia</label>
