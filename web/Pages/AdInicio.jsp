                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <img src="../Media/Imagenes/car1.jpg" alt="Chania" width="1100" height="600">
                                    </div>

                                    <div class="item">
                                        <img src="../Media/Imagenes/car2.jpg" alt="Chania" width="1100" height="600">
                                    </div>

                                    <div class="item">
                                        <img src="../Media/Imagenes/car3.jpg" alt="Flower" width="1100" height="600">
                                    </div>

                                    <div class="item">
                                        <img src="../Media/Imagenes/car4.jpg" alt="Flower" width="1100" height="600">
                                    </div>
                                </div>
                            </div>
                        </div>
