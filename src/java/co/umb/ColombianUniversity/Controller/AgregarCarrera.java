...
public class AgregarCarrera extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombre = request.getParameter("txtNombreCarrera");
        String titulo = request.getParameter("txtTituloCarrera");
        
        if(!nombre.isEmpty()&&!titulo.isEmpty()&&CarreraDAO.materiasPlan.size()>=5)
        {
            new CarreraDAO().agregarPlanMaterias(nombre, titulo);
